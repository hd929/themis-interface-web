...
<div id="body">
  <div class='datatable' style='background-color: #E1E1E1; padding-bottom: 3px;position:absolute;'>
    ...
    <div style="padding: 4px 0 0 6px;font-size:1em;position:relative;">
      <h2 style="color:#445f9d;margin-left:10px">Bảng xếp hạng</h2>
    </div>

    <div style="background-color: white;margin:0.3em 3px 0 3px;position:relative;">
      <table class="standings">
        <?php function swap(&$xm, &$ym)
        {
          $tmp = $xm;
          $xm = $ym;
          $ym = $tmp;
        ...
        <tr>
          ...
          <th style='text-align:left;min-width:250px;color:#445f9d;'>
            <h3> Thí Sinh </h3>
          </th>
          <th style='color:#445f9d;min-width:80px'>
            <h4> Tổng </h4>
          </th>
  ...
  <a href="#" id="loadMore" style="color: #33739E;text-decoration: none;display: block;margin: 10px 0;">
    <font color="red">Load more</font>
  </a>
</div>
<script>
  $(function() {
